...
<div id="header"></div>
    ...
    <div class="wrap">
        <div class="bread_box">
            ...
            <a href="#">${rroute.routeIntroduce}</a>
        </div>
     <div class="prosum_box">
            <dl class="prosum_left">
                ...
                <dd id="dd">
                    <a class="up_img up_img_disable"></a>
                     ...
                     <c:forEach items="${routeImgList}" var="r">
                    <a title="" class="little_img" data-bigpic="${r.smallPic}">
            ...
            <div class="prosum_right">
               ...
               <p class="pros_title" id="rname">${rroute.rname}</p>
             
                <p class="hot" id="routeIntroduce">${rroute.routeIntroduce}</p>
                <div class="pros_other">
                    <p >经营商家  ：<span id="sname">星途国旅</span></p>
                    <p >咨询电话 : <span id="consphone">400-842-6420</span></p>
                    <p >地址 ： <span id="address">安徽星途旅游有限公司</span></p>
                </div>
                <div class="pros_price">
                      <p class="price"><strong id="price">¥${rroute.price}</strong><span>起</span></p>
                    <p class="collect">
    ...
    $(function () {
       ...
       //2.发送请求请求 route/findOne
        $.get("route/findOne",{rid:rid},function (route) {
            //3.解析数据填充html
            $("#rname").jsp(route.rname);
            $("#routeIntroduce").jsp(route.routeIntroduce);
            $("#price").jsp("¥"+route.price);
            $("#sname").jsp(route.seller.sname);
            $("#consphone").jsp(route.seller.consphone);
            $("#address").jsp(route.seller.address);
            //设置收藏次数
            $("#favoriteCount").jsp("已收藏"+route.count+"次");
    ...
    function addFavorite(){
        ...
        $.get("user/findOne",{},function (user) {
           if(user){
               ...
               //用户没有登录
               alert("您尚未登录，请登录");
               location.href="http://localhost/travel/login.jsp";
           }
        })
    }
